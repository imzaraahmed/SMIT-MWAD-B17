...
const Hero = () => {
    return (
        <>
        <section style={{backgroundImage: `url(${bg})`,backgroundSize: "cover",backgroundPosition: "center",height: "100vh",display: "flex",
            ...
            <div style={{backgroundColor: "rgba(0, 0, 0, 0.5)", padding: "40px",borderRadius: "10px",}}>
                ...
                <button style={{backgroundColor: "white",color: "purple",border: "none",padding: "12px 24px",
            borderRadius: "6px",cursor: "pointer",fontSize: "18px",fontWeight: "bold",}}
            >Click Me
            </button>
            </div>
        </section>
